...
<body class="font-sans antialiased">
    ...
    <div class="max-w-7xl mx-auto mt-10 mb-12 flex items-center justify-center p-4 lg:p-8 relative z-10">
        ...
        <div class="flex flex-col">
            ...
            <img class="w-full rounded-lg border mt-12 shadow mx-auto border-t border-t-gray-100 h-full" src="{{ getenv('APP_URL') . ':8000/dashboard.png' }}" alt="ApoloAI" />
        </div>
    </div>
    ...
    <section class="max-w-7xl flex flex-col justify-center h-full items-center mx-auto p-4 md:mt-26">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 my-28">
            ...
            <img class="w-full rounded-lg border shadow mx-auto border-t border-t-gray-100 h-full" src="{{ getenv('APP_URL') . ':8000/notas.png' }}" alt="ApoloAI" />
        </div>
    ...
    <section class="max-w-7xl flex flex-col justify-center h-full items-center mx-auto p-4 md:mt-26">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 my-28">
            ...
            <img class="w-full rounded-lg border shadow mx-auto border-t border-t-gray-100 h-full" src="{{ getenv('APP_URL') . ':8000/analise.png' }}" alt="ApoloAI" />
        </div>

    </section>


    <footer class="max-w-7xl mx-auto text-center flex border-t flex-col justify-center h-full items-center p-10 mt-26 text-gray-500">
