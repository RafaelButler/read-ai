<aside
    class="fixed inset-y-0 left-0 z-10 flex-col hidden border-r dark:border-r-gray-800 dark:text-gray-400 w-14 bg-white/100 dark:bg-gray-800 sm:flex">
    <nav class="flex flex-col items-center gap-4 px-2 sm:py-5">
        ...
        <a
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 ...
                 class="lucide lucide-library-icon w-5 h-5">
        ...
        <button data-state="closed"><a
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                     stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                     class="lucide lucide-line-chart-icon w-5 h-5">
    ...
    <nav class="flex flex-col items-center gap-4 px-2 mt-auto sm:py-5"><a
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                 class="lucide lucide-settings-icon w-5 h-5">
                <path
